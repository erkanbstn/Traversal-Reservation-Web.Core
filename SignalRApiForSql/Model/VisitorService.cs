...
namespace SignalRApiForSql.Model
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "Select tarih,[1],[2],[3],[4],[5] from (select[City],CityCount,Cast([VisitDate] as Date) as tarih from Visitors)\r\nas visitTable Pivot (Sum(CityCount) for City in ([1],[2],[3],[4],[5])) as pivottable order by tarih asc";
